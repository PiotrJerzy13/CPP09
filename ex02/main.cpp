...
/*   Updated: 2025/03/22 14:12:56 by pwojnaro         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(int argc, char* argv[]) 
{
    ...
    // Create vector and list with the same elements
    ...
    std::cout << "Time to process a range of " << numbers.size() 
              << " elements with std::vector : " << vectorSorter.getExecutionTime() 
              << " ms" << std::endl;
    
    std::cout << "Time to process a range of " << numbers.size() 
              << " elements with std::list : " << listSorter.getExecutionTime() 
              << " ms" << std::endl;
